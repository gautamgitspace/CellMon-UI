...
public class PieChartActivity extends BaseActivity implements OnSeekBarChangeListener, OnChartValueSelectedListener
{
    ...
    private SpannableString generateCenterSpannableText() {
        ...
        SpannableString s = new SpannableString("Cellular Data Stats\nPowered by CellMon inc");
        Log.v("LEN", "TOTAL LEN IS" + s.length());
        s.setSpan(new RelativeSizeSpan(1.7f), 0, 14, 0);
        s.setSpan(new StyleSpan(Typeface.NORMAL), 19, s.length() - 15, 0);
